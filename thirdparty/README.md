...
12-bit wavelet intermediate.

Files extracted from upstream source:

- `Codec/`, `Common/`, `EncoderSDK/` and `WarpLib/` folders
- `LICENSE-APACHE`, `LICENSE-MIT` and `README.md`

The decoder (`DecoderSDK/`), the conversion helpers (`ConvertLib/`) and the examples are not
included, as only the encoder is used.
